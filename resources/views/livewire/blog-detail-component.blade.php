                    ...
                    <div class="single-page pr-30">
                        ...
                        <div class="entry-bottom mt-50 mb-30 wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
                            <div class="tags w-50 w-sm-100">
                                ...
                                <a href="blog.html" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">nature</a>
                                <a href="blog.html" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">conserve</a>
                            </div>
                            <div class="social-icons single-share">
                                <ul class="text-grey-5 d-inline-block">
                                    <li><strong class="mr-10">Share this:</strong></li>
                        ...
                        <div class="sidebar-widget widget_alitheme_lastpost mb-20">
                            ...
                            <div class="row">
                                <div class="col-12 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets/imgs/blog/blog-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets/imgs/blog/blog-3.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets/imgs/blog/blog-4.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets/imgs/blog/blog-5.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
