                        ...
                        <div class="row">
                                ...
                                <article class="first-post mb-30 wow fadeIn animated hover-up">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="mb-20 entry-meta meta-2">
                                            ...
                                            <a href="{{ route('blog.detail') }}" class="btn btn-sm">Read more<i class="fi-rs-arrow-right ml-10"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                                ...
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('blog.detail') }}">The litigants on the screen are not actors</a></h3>
                                        ...
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            ...
                                            <a href="{{ route('blog.detail') }}" class="text-brand">Read more <i class="fi-rs-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('blog.detail') }}">Essential Qualities of Highly Successful Music</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('blog.detail') }}">9 Things I Love About Shaving My Head</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('blog.detail') }}">Why Teamwork Really Makes The Dream Work</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('blog.detail') }}">The World Caters to Average People</a></h3>
