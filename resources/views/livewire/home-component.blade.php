                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                ...
                                <div class="product-action-1">
                                    ...
                                    <a aria-label="Add To Wishlist" class="action-btn small hover-up" href="#" tabindex="0" wire:click.prevent="addToWishlist({{ $lproduct->id }}, '{{ $lproduct->name }}', {{ $lproduct->regular_price }})"><i class="fi-rs-heart"></i></a>
