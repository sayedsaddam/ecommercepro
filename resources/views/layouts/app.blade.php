                                            ...
                                            <ul class="mega-menu">
                                                <li class="sub-mega-menu sub-mega-menu-width-22">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('shop') }}">Hoodies & Sweatshirts</a></li>
                                                        <li><a href="{{ route('shop') }}">Wedding Dresses</a></li>
                                                        <li><a href="{{ route('shop') }}">Prom Dresses</a></li>
                                                        <li><a href="{{ route('shop') }}">Cosplay Costumes</a></li>
                                                    </ul>
                                                </li>
                                                <li class="sub-mega-menu sub-mega-menu-width-22">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('shop') }}">Casual Faux Leather</a></li>
                                                        <li><a href="{{ route('shop') }}">Genuine Leather</a></li>
                                                        <li><a href="{{ route('shop') }}">Casual Pants</a></li>
                                                        <li><a href="{{ route('shop') }}">Sweatpants</a></li>
                                                        <li><a href="{{ route('shop') }}">Harem Pants</a></li>
                                                    </ul>
                                                </li>
                                                <li class="sub-mega-menu sub-mega-menu-width-22">
                                                    <a class="menu-title" href="#">Technology</a>
                                                    <ul>
                                                        <li><a href="{{ route('shop') }}">Gaming Laptops</a></li>
                                                        <li><a href="{{ route('shop') }}">Ultraslim Laptops</a></li>
                                                        <li><a href="{{ route('shop') }}">Tablets</a></li>
                                                        <li><a href="{{ route('shop') }}">Laptop Accessories</a></li>
                                                        <li><a href="{{ route('shop') }}">Tablet Accessories</a></li>
                                                    </ul>
                                                </li>
                                                <li class="sub-mega-menu sub-mega-menu-width-34">
                                                    <div class="menu-banner-wrap">
                                                        <a href="{{ route('shop') }}"><img src="{{ asset('assets/imgs/banner/menu-banner.jpg') }}" alt="Surfside Media"></a>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="{{ route('shop') }}"><img alt="Surfside Media" src="{{ asset('assets/imgs/shop/thumbnail-3.jpg') }}"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="{{ route('shop') }}">Plain Striola Shirts</a></h4>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="{{ route('shop') }}"><img alt="Surfside Media" src="{{ asset('assets/imgs/shop/thumbnail-4.jpg"') }}></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="{{ route('shop') }}">Macbook Pro 2022</a></h4>
                                    ...
                                    <ul class="dropdown">
                                        <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Women's Fashion</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="{{ route('shop') }}">Blouses & Shirts</a></li>
                                                <li><a href="{{ route('shop') }}">Hoodies & Sweatshirts</a></li>
                                                <li><a href="{{ route('shop') }}">Women's Sets</a></li>
                                            </ul>
                                        </li>
